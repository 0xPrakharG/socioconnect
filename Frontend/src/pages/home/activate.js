...
export default function Activate() {
  ...
  return (
    ...
    <div className="min-h-[100vh] bg-secondary grid">
      {success && (
        <ActivateForm type="success" header="Account Activation Succeeded" text={success} loading={loading} />
      )}
      {error && (
        <ActivateForm type="error" header="Account Activation failed" text={error} loading={loading} />
      )}
      <Header />
      <LeftHome user={user} />
